...
void Manipulation_ManipulationPlannerServiceSVC_impl::planManipulation(const Manipulation::RobotIdentifier& robotID, const Manipulation::RobotJointInfo& startRobotJointInfo, const Manipulation::RobotJointInfo& goalRobotJointInfo, Manipulation::ManipulationPlan_out manipPlan)
{
	...
	//m_rtcPtr->callGetModelInfo(robotID, m_robotJointInfo);
		...
		m_robotJointInfo->jointInfoSeq[0].minAngle = -160.0;
		m_robotJointInfo->jointInfoSeq[0].maxAngle = 160.0;
		...
		m_robotJointInfo->jointInfoSeq[1].minAngle = -65.0;
		m_robotJointInfo->jointInfoSeq[1].maxAngle = 130.0;
		...
		m_robotJointInfo->jointInfoSeq[2].minAngle = -10.0;
		m_robotJointInfo->jointInfoSeq[2].maxAngle = 150.0;
		...
		m_robotJointInfo->jointInfoSeq[3].minAngle = -160.0;
		m_robotJointInfo->jointInfoSeq[3].maxAngle = 160.0;
		...
		m_robotJointInfo->jointInfoSeq[4].minAngle = -95.0;
		m_robotJointInfo->jointInfoSeq[4].maxAngle = 135.0;
		...
		m_robotJointInfo->jointInfoSeq[5].minAngle = -170.0;
		m_robotJointInfo->jointInfoSeq[5].maxAngle = 170.0;
